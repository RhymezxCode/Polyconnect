                            ...
                            <div class="filter--nav pb--60 clearfix">
                                <div class="filter--links float--left">
                                    <ul class="nav ff--primary">
                                        ...
                                        <li class="active"><a href="member-activity-mentions.php">Mentions</a></li>
                                ...
                                <ul class="activity--items nav">
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Leticia J. Espinosa</a> posted an update</p>
                                                </div>
                                                ...
                                                <div class="activity--content">
                                                    <p>I will miss you <a href="#">@Eileen K. Ruiz</a></p>
                                                </div>
                                                            ...
                                                            <div class="acomment--item clearfix">
                                                                ...
                                                                <div class="acomment--info">
                                                                    <div class="acomment--header">
                                                                        <p><a href="member-activity-personal.php">Eileen K. Ruiz</a> Replied</p>
                                                                    </div>
                                                                    ...
                                                                    <div class="acomment--content">
                                                                        ...
                                                                        <p><a href="#">@Alexander M. Estrada</a></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
