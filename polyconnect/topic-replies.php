                            ...
                            <div class="topic--replies">
                                <ul class="nav">
                                    <li>
                                        ...
                                        <div class="topic--reply">
                                            <div class="header clearfix">
                                                <p class="date float--left">19th January 2017 at 9:20 pm</p>
                                    ...
                                    <li>
                                        ...
                                        <div class="topic--reply">
                                            <div class="header clearfix">
                                                <p class="date float--left">12th April 2017 at 12:10 pm</p>
                                            ...
                                            <div class="body clearfix">
                                                <div class="author mr--20 float--left text-center">
                                                    <div class="avatar" data-overlay="0.3" data-overlay-color="primary">
                                                        <a href="member-activity-personal.php">
                                                            <img src="img/topics-img/avatar-02.jpg" alt="">
                                                        </a>
                                                    </div>

                                                    <div class="name text-darkest">
                                                        <p><a href="member-activity-personal.php">David J. Kleiner</a></p>
                                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="topic--reply">
                                            <div class="header clearfix">
                                                <p class="date float--left">3rd June 2017 at 5:30 pm</p>
                                            ...
                                            <div class="body clearfix">
                                                <div class="author mr--20 float--left text-center">
                                                    <div class="avatar" data-overlay="0.3" data-overlay-color="primary">
                                                        <a href="member-activity-personal.php">
                                                            <img src="img/topics-img/avatar-03.jpg" alt="">
                                                        </a>
                                                    </div>

                                                    <div class="name text-darkest">
                                                        <p><a href="member-activity-personal.php">Janice Day</a></p>
                                                    </div>
                                        ...
                                        <div class="topic--reply">
                                            ...
                                            <div class="body clearfix">
                                                <div class="author mr--20 float--left text-center">
                                                    <div class="avatar" data-overlay="0.3" data-overlay-color="primary">
                                                        <a href="member-activity-personal.php">
                                                            <img src="img/topics-img/avatar-04.jpg" alt="">
                                                        </a>
                                                    </div>

                                                    <div class="name text-darkest">
                                                        <p><a href="member-activity-personal.php">Michael Oliver</a></p>
                                                    </div>
                                        ...
                                        <div class="topic--reply">
                                            ...
                                            <div class="body clearfix">
                                                <div class="author mr--20 float--left text-center">
                                                    <div class="avatar" data-overlay="0.3" data-overlay-color="primary">
                                                        <a href="member-activity-personal.php">
                                                            <img src="img/topics-img/avatar-05.jpg" alt="">
                                                        </a>
                                                    </div>

                                                    <div class="name text-darkest">
                                                        <p><a href="member-activity-personal.php">Doris Mendez</a></p>
                                                    </div>
