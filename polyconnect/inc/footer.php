 <!-- Footer Section Start -->
                        ...
                        <div class="col-md-3 col-xs-6 col-xxs-12 pb--60">
                            ...
                            <div class="widget">
                                ...
                                <div class="text--widget">
                                    ...
                                    <p>This is a project from a final year student of yaba college of technology</p>
                                </div>
                                <!-- Text Widget End -->
                            </div>
                            <!-- Widget End -->
                                ...
                                <div class="newsletter--widget style--1" data-form="validate">
                                    <form action="#" method="post" name="mc-embedded-subscribe-form" target="_blank">
                                        <div class="input-group">
                                            <input type="email" name="EMAIL" placeholder="Enter your email address here" class="form-control" autocomplete="off" required>
                                    ...
                                    <ul class="nav">
                                        <li>
                                            <a href="#">
                                                ...
                                                <span class="text">computer technology</span>
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-folder-o"></i>
                                                <span class="text">food technology</span>
                                        ...
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-folder-o"></i>
                                                <span class="text">Arcitechure</span>
                        ...
                        <div class="col-md-3 col-xs-6 col-xxs-12 pb--60">
                            ...
                            <div class="widget">
                                ...
                                <div class="links--widget">
                                    <ul class="nav">
                                        <li><a href="sub-forums.html">Science and technology</a></li>
                                        <li><a href="sub-forums.html">Engineering</a></li>
                                        <li><a href="sub-forums.html">enviromental </a></li>
                                        <li><a href="sub-forums.html">business administration</a></li>
                                        <li><a href="sub-forums.html">SLT</a></li>
                                    </ul>
                                </div>
                                <!-- Links Widget End -->
                            </div>
                            ...
                            <div class="widget">
                                ...
                                <div class="links--widget">
                                    <ul class="nav">
                                        ...
                                        <li><a href="member-friends.php">Members on Polyconnect</a></li>
            ...
            <div class="footer--copyright pt--30 pb--30 bg-darkest">
                <div class="container">
                    <div class="text fw--500 fs--14 text-center">
                        <p>Copyright &copy; Poly<span>Connect</span>. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
    ...
    <script src="<?php echo BASE_URL;?>bootstrap-3.3.5-dist/bootstrap-3.3.5-dist/js/bootstrap.min.js" ></script>
