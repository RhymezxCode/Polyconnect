                        ...
                        <div class="main--content-inner drop--shadow">
                            ...
                            <div class="filter--nav pb--60 clearfix">
                                <div class="filter--link float--left">
                                    <h2 class="h4"><a href="members.php" class="btn-link">All Members : 30,000</a></h2>
                                </div>
                                ...
                                <ul class="activity--items nav">
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Eileen K. Ruiz</a> update her profile picture</p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Samuel C. Azevedo</a> posted an update in the group <a href="group-home.php">Travel Guides</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Denise R. Sherman</a> posted an update in the group <a href="group-home.php">Pet Care</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Lee E. Jones</a> Shared a link</p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Bonnie P. Rock</a> posted an update</p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Anita J. Lilley</a> posted an update in the group <a href="group-home.php">Lens-bians Photography</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Carl A. Toler</a> posted an update with his friend <a href="member-activity-personal.php">Susan J. Bounds</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Martina B. Scott</a> feeling happy with <a href="member-activity-personal.php">Eva C. Rucker</a> and <a href="#">5 more others</a></p>
                                                </div>
