...
<body>
 ...
 <!-- dropdown here -->
        ...
        <div class="page--header pt--60 pb--60 text-center" data-bg-img="img/page-header-img/bg.jpg" data-overlay="0.85">
            <div class="container">
                <div class="title">
                    <h2 class="h1 text-white">Front-End Engineering</h2>
                </div>

                <ul class="breadcrumb text-gray ff--primary">
                    <li><a href="home-1.php" class="btn-link">Home</a></li>
                    <li><a href="forums.php" class="btn-link">Forum</a></li>
                    <li class="active"><span class="text-primary">Front-End Engineering</span></li>
                </ul>
            </div>
        </div>
        <!-- Page Header End -->
                            ...
                            <div class="topics--list">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topics.php" class="btn-link">HTML (Hypertext Markup Language)</a></h4>
                                            ...
                                            <td>
                                                <p class="ff--primary fw--500 fs--14 text-darkest">245</p>
                                            </td>
                                            <td>
                                                <p>2 days, 5 hours ago</p>

                                                <a href="member-activity-personal.php" class="topic--author">
                                                    <span class="name">Michael F. Boothe</span>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topics.php" class="btn-link">CSS (Cascading Style Sheets)</a></h4>
                                            ...
                                            <td>
                                                ...
                                                <a href="member-activity-personal.php" class="topic--author">
                                                    <span class="name">Christine H. Yepez</span>
                                                    <span class="avatar"><img src="img/topics-img/avatar-01.jpg" alt=""></span>
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            <div class="topics--list">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">How do I become a front-end engineer?</a></h4>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">I want to be a front-end engineer</a></h4>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">Learning front-end engineeringr</a></h4>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">How's the job market for front-end engineers?</a></h4>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">Where should I take a front-end engineering course?</a></h4>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">How to get front-end engineers list?</a></h4>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">Advantages of front-end engineer</a></h4>
