                        ...
                        <div class="main--content-inner drop--shadow">
                            ...
                            <div class="content--nav pb--30">
                                <ul class="nav ff--primary fs--14 fw--500 bg-lighter">
                                    <li class="active"><a href="group-home.php">Home</a></li>
                                ...
                                <ul class="activity--items nav">
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Eileen K. Ruiz</a> joined the group <a href="group-home.php">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Samuel C. Azevedo</a> posted an update in the group <a href="group-home.php">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Denise R. Sherman</a> shared her new experience about recipes in the group <a href="group-home.php">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Leticia J. Espinosa</a> posted an update in the group <a href="group-home.php">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Bonnie P. Rock</a> shared a link in the group <a href="group-home.php">Food Recipes</a></p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Anita J. Lilley</a> posted an update in the group <a href="group-home.php">Food Recipes</a></p>
                                                </div>
