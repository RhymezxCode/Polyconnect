...
<div id="mid_container" class="bg">
  <div id="mid" class="box wall">
    ...
    <input type="text" id="post_title" style="width:100%; margin-bottom:11px;display:none" placeholder="Title"/>
    <textarea id="post_text"  style="margin-bottom:1px" placeholder="Text"></textarea>
