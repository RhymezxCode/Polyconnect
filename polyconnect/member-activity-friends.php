                            ...
                            <div class="filter--nav pb--60 clearfix">
                                <div class="filter--links float--left">
                                    <ul class="nav ff--primary">
                                        ...
                                        <li class="active"><a href="member-activity-friends.php">Friends</a></li>
                                ...
                                <ul class="activity--items nav">
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Martina B. Scott</a> Chnged his profile picture at <a href="#"><i class="fa ml--4 mr--4 fa-map-marker"></i> Atlanta, United States</a></p>
                                                </div>
                                                ...
                                                <div class="activity--content">
                                                    ...
                                                    <div class="img--embed">
                                                        <img src="img/activity-img/profile-pic-09.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Samuel C. Azevedo</a> posted an update</p>
                                                </div>
                                                ...
                                                <div class="activity--content">
                                                    <p>I’m fall in love with <a href="#">@Mellisa E. Torres</a></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Activity Item End -->
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Denise R. Sherman</a> posted an update</p>
                                                </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p><a href="member-activity-personal.php">Anita J. Lilley</a> felling verry happy <i class="fa ml--4 mr--4 fa-smile-o"></i> with <a href="member-activity-personal.php">Patsy W. Taylor</a> and <a href="#">6 more others</a></p>
                                                </div>
