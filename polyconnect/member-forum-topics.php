            ...
            <div class="header--topbar bg-black">
                <div class="container">
                    ...
                    <ul class="header--topbar-links nav ff--primary float--right">
                        <li>
                            <a href="cart.php" title="Notification" data-toggle="tooltip" data-placement="bottom">
                        ...
                        <div class="main--content-inner drop--shadow">
                            ...
                            <div class="filter--nav pb--50 clearfix">
                                <div class="filter--links float--left">
                                    <ul class="nav ff--primary">
                                        <li class="active"><a href="member-forum-topics.php">Topics Started</a></li>
                                        <li><a href="member-forum-replies.php">Replies Created</a></li>
                            ...
                            <div class="forum--header pb--50">
                                <div class="forum--title">
                                    <h3 class="h3 fw--500 text-default">Forum Topics Started</h3>
                                </div>
                                    ...
                                    <tbody>
                                        <tr class="pinned">
                                            <td>
                                                ...
                                                <p>Started by <a href="member-activity-personal.php">Alice A. Baker</a> in <a href="topics.php">sports</a> forum</p>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">General Relationship Discussion</a></h4>

                                                <p>Started by <a href="member-activity-personal.php">David J. Kleiner</a> in <a href="topics.php">Relationship</a> forum</p>
                                            </td>
                                            <td>
                                                <p class="ff--primary fw--500 fs--14 text-darkest">02</p>
                                            </td>
                                            <td>
                                                <p class="ff--primary fw--500 fs--14 text-darkest">09</p>
                                            </td>
                                            <td>
                                                <p>6 days, 10 hours ago</p>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">Design</a></h4>

                                                <p>Started by <a href="member-activity-personal.php">Barbara L. Posey</a> in <a href="topics.php">UI/UX Designers Community</a> forum</p>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">Travel</a></h4>

                                                <p>Started by <a href="member-activity-personal.php">William C. Morgan</a> in <a href="topics.php">Truist</a> forum</p>
                                            </td>
                                            <td>
                                                <p class="ff--primary fw--500 fs--14 text-darkest">06</p>
                                            </td>
                                            <td>
                                                <p class="ff--primary fw--500 fs--14 text-darkest">18</p>
                                            </td>
                                            <td>
                                                <p>1 day, 8 hours ago</p>
                                        ...
                                        <tr>
                                            <td>
                                                <h4 class="h6 fw--500 text-darkest"><a href="topic-replies.php" class="btn-link">Take Care Your Health</a></h4>

                                                <p>Started by <a href="member-activity-personal.php">Diane H. Guzman</a> in <a href="topics.php">Health Tips</a> forum</p>
                                            </td>
                                            <td>
                                                <p class="ff--primary fw--500 fs--14 text-darkest">02</p>
                                            </td>
                                            <td>
                                                <p class="ff--primary fw--500 fs--14 text-darkest">03</p>
                                            </td>
                                            <td>
                                                <p>2 days, 5 hours ago</p>
